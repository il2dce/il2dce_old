...
//        public System.Collections.Generic.List<AirGroup> AirGroups
//        {
//            get
//            {
...
//        public System.Collections.Generic.List<AirGroup> RedAirGroups
//        {
//            get
//            {
//                List<AirGroup> airGroups = new List<AirGroup>();
...
//        public System.Collections.Generic.List<AirGroup> BlueAirGroups
//        {
//            get
//            {
//                List<AirGroup> airGroups = new List<AirGroup>();
...
//        public System.Collections.Generic.List<GroundGroup> GroundGroups
//        {
//            get
//            {
...
//        public System.Collections.Generic.List<GroundGroup> RedGroundGroups
//        {
//            get
//            {
//                List<GroundGroup> groundGroups = new List<GroundGroup>();
...
//        public System.Collections.Generic.List<GroundGroup> BlueGroundGroups
//        {
//            get
//            {
//                List<GroundGroup> groundGroups = new List<GroundGroup>();
...
//        private List<AirGroup> getAvailableEnemyAirGroups(Army army)
//        {
//            List<AirGroup> airGroups = new List<AirGroup>();
//            foreach (AirGroup airGroup in availableAirGroups)
//            {
//                if (airGroup.Army != army)
//                {
...
//        private AirGroup getAvailableRandomEnemyAirGroup(Army army)
//        {
//            List<AirGroup> airGroups = getAvailableEnemyAirGroups(army);
...
//        private List<AirGroup> getAvailableFriendlyAirGroups(Army army)
//        {
//            List<AirGroup> airGroups = new List<AirGroup>();
//            foreach (AirGroup airGroup in availableAirGroups)
//            {
...
//        private AirGroup getAvailableRandomFriendlyAirGroup(Army army)
//        {
//            List<AirGroup> airGroups = getAvailableFriendlyAirGroups(army);
...
//        private List<AirGroup> getAvailableOffensiveAirGroups(Army army)
//        {
//            List<AirGroup> airGroups = new List<AirGroup>();
//            foreach (AirGroup airGroup in availableAirGroups)
//            {
...
//        private AirGroup getAvailableRandomOffensiveAirGroup(Army army)
//        {
//            List<AirGroup> airGroups = getAvailableOffensiveAirGroups(army);
...
//        private List<AirGroup> getAvailableEscortedAirGroups(Army army)
//        {
//            List<AirGroup> airGroups = new List<AirGroup>();
//            foreach (AirGroup airGroup in availableAirGroups)
//            {
...
//        private AirGroup getAvailableRandomEscortedAirGroup(Army army)
//        {
//            List<AirGroup> airGroups = getAvailableEscortedAirGroups(army);
//            if (airGroups.Count > 0)
//            {
...
//            foreach (AirGroup airGroup in availableAirGroups)
//            {
//                if (airGroup.Army == targetAirUnit.Army)
//                {
...
//            {
//                List<Stationary> radars = getEnemyRadars(airGroup.Army);
//                if (radars.Count > 0)
//                {
//                    return true;
//                }
...
//            {
//                List<Stationary> enemyAircrafts = getEnemyAircrafts(airGroup.Army);
...
//            if (this.Core.GamePlay.gpAirGroups(airGroup.Army) != null && this.Core.GamePlay.gpAirGroups(airGroup.Army).Length > 0)
//            {
//                foreach (maddox.game.world.AiAirGroup aiAirGroup in this.Core.GamePlay.gpAirGroups(airGroup.Army))
//                {
...
//        private void createAirOperation(IBriefingFile briefingFile, AirGroup airGroup, EMissionType missionType, bool allowIntercept, AirGroup forcedEscortAirGroup)
//        {
...
//                if (missionType == EMissionType.COVER)
//                {
//                    AirGroup offensiveAirGroup = getAvailableRandomOffensiveAirGroup(airGroup.Army);
...
//                            createAirOperation(briefingFile, offensiveAirGroup, randomOffensiveMissionType, false, null);
...
//                    createRandomGroundOperation(null, groundGroup);
...
//                else if (missionType == EMissionType.ATTACK_AIRCRAFT)
//                {
//                    List<Stationary> aircrafts = getEnemyAircrafts(airGroup.Army);
...
//                    createAirOperation(briefingFile, airGroup, randomMissionType, true, null);
//                }
//                else
//                {
...
//                    if (AirGroupInfo.GetAirGroupInfo(1, airGroup.Regiment) != null)
//                    {
//                        getAirGroups(1).Add(airGroup);
//                    }
//                    else if (AirGroupInfo.GetAirGroupInfo(2, airGroup.Regiment) != null)
//                    {
...
//            {
//                if ((airGroup.Regiment + "." + airGroup.SquadronIndex.ToString(System.Globalization.CultureInfo.InvariantCulture.NumberFormat)) == this.Core.CurrentCareer.AirGroup)
//                {
//                    createRandomAirOperation(missionFile, briefingFile, airGroup);
...
//                    string playerAirGroupKey = airGroup.Regiment;
