...
//private bool isAiControlledPlane (AiAircraft aircraft); // fix again ???
using System;
using System.Text;
...
//public class Mission : IL2DCE.Mission.MissionSingle
{
    ...
    private bool isAiControlledPlane(AiAircraft aircraft)       // Added - vP
    {
        if (aircraft == null)
            return false;
    ...
    public override void OnTrigger(int missionNumber, string shortName, bool active)       // Added - vP
    {
    ...
    public override void OnAircraftDamaged(int missionNumber, string shortName, AiAircraft aircraft, AiDamageInitiator DamageFrom, part.NamedDamageTypes WhatDamaged)
    {
        ...
        if (DamageFrom.Player != null)
        {
            ...
            //GamePlay.gpHUDLogCenter(null, "script working- hit scored");		//Test
            if ((debugOn == 1) || (displayDamage == 1)) { GamePlay.gpLogServer(null, "{0} hits {1} : {2} \n", new object[] { DamageFrom.Player, shortName, WhatDamaged }); }	//Test
        }
    }
    ...
    public override void OnAircraftCrashLanded(int missionNumber, string shortName, AiAircraft aircraft)
    {
        ...
        if (debugOn == 1) { GamePlay.gpHUDLogCenter(null, "script working- AC Crashed"); }		//Test
    ...
    {
        if (debugOn == 1) { GamePlay.gpHUDLogCenter(null, "script working- AC landed"); }		//Test
        ...
        {
            if (debugOn == 1) { GamePlay.gpHUDLogCenter(null, "script working- human landed"); }		//Test
